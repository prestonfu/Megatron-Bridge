...
from megatron.bridge.recipes.nemotronh import nemotron_3_nano_peft_config, nemotron_3_nano_sft_config
...
DEFAULT_CONFIG_FILE = SCRIPT_DIR / "conf" / "nemotron_3_nano_finetune.yaml"
...
def main() -> None:
    ...
    if args.peft == "none":
        config: ConfigContainer = nemotron_3_nano_sft_config()
    else:
        config: ConfigContainer = nemotron_3_nano_peft_config(peft_scheme=args.peft)
