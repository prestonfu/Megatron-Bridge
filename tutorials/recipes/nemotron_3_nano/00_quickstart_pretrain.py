...
"""
Quickstart: Pretrain Nemotron 3 Nano (30B-A3B MoE) with Megatron Bridge

Usage:
    Multiple GPUs (requires TP=4, EP=8 by default):
...
def main() -> None:
    """Run Nemotron 3 Nano pretraining with default configuration."""

    # Load the base recipe configuration
    # Nemotron 3 Nano is a MoE model requiring TP=4, EP=8 by default
