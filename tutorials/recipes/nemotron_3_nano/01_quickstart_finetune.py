...
"""
Quickstart: Finetune Nemotron 3 Nano (30B-A3B MoE) with Megatron Bridge

Usage:
    With LoRA (EP=8 by default):
...
from megatron.bridge.recipes.nemotronh import nemotron_3_nano_peft_config
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Finetune Nemotron 3 Nano with LoRA",
...
def main() -> None:
    """Run Nemotron 3 Nano finetuning with LoRA."""
    args = parse_args()

    # Load the base PEFT (LoRA) configuration
    # Nemotron 3 Nano MoE uses TP=1, EP=8 for finetuning by default
    ...
    # For full finetuning, use the SFT config instead:
    # from megatron.bridge.recipes.nemotronh import nemotron_3_nano_sft_config
